...
- The discovery boundary (#145) defines supported declarations, portable glob
  ...
  descriptor/inode watches, ordinary final descriptor reads compared with
  captured bytes and shared-mapping mismatch restart/fail behavior, read-only
  absent-root handling, portable graph
