...
- The discovery boundary (#145) defines supported declarations, portable glob
  ...
  descriptor/inode watches, ordinary final descriptor stable reads covering
  shared-mapping writes, read-only absent-root handling, portable graph
