...
- The discovery boundary (#145) defines supported declarations, portable glob
  ...
  descriptor/inode watches, a content-version cut covering shared-mapping
  writes, read-only absent-root handling, portable graph
